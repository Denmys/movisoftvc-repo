<section class="section-g-padding bg-light" id="contacto">
        <div class="container">
            ...
            <div class="row justify-content-center" data-aos="fade-down" data-aos-delay="250">
                <div class="col-lg-8">
                    <form action="https://formsubmit.co/administrador@movisoftvc.com" method="POST" class="row g-3 p-lg-5 p4 bg-white theme-shadow">
                        ...
                        <div class="form-group col-lg-12 d-grid">
                            ...
                            <input type="hidden" name="_next" value="https://www.movisoftvc.com/">
