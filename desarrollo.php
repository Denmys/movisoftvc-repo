...
<head>
    ...
    <meta property="og:description" content="Ponemos a su disposición un equipo profesional y comprometido, lo cual nos permite agilizar nuestro trabajo y brindar soluciones informáticas inspiradoras."></meta>
    <meta property="og:title" content="Desarrollo de Software - Movisoftvc"></meta>
    <meta property="og:site_name" content="MovisoftVC - La mejor opción para tu empresa."></meta>

    <link rel="icon" type="image/png" sizes="16x16" href="./assets/images/fav-icon/favicon-16x16.png">

    <title>Desarrollo de Software - Movisoft</title>
...
<body>
    ...
    <section id="pag-servicios" class="min-vh-100 d-flex align-items-center text-center">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 data-aos="fade-left" class="bienvenida text-uppercase text-white fw-semibold display-1">Desarrollo de Software</h1>
                    <h5 class="bienvenida text-white mt-3 mb-4" data-aos="fade-right">Nuestra meta como agencia digital interactiva es crear y desarrollar productos sobresalientes con las mejores herramientas tecnológicas de la industria.</h5>
                    <div data-aos="fade-up" data-aos-delay="50">
                        <a href="#desarrollo" class="btn btn-brand me-2">Ver Más</a>
                        <a href="#contacto" class="btn btn-brand me-2">Contáctenos</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="col-12 text-center" data-aos="fade-down" data-aos-delay="50">
                    <div class="section-title">
                        <h1 class="title display-4 fw-semibold">Desarrollo y Programación Web</h1>
                        <div class="line"></div>
                        <h5>El diseño de una página web a medida, con todas las funcionalidades necesarias, fácil de navegar e intuitiva es lo que todas las empresas quieren para su negocio. No solo es una cuestión de imagen de marca. El desarrollo web debe adecuarse a las necesidades de tu empresa, con una visión directa y concisa. Por eso, es otro de los servicios informáticos que más se solicitan.
                        Nuestra meta como agencia digital interactiva es crear y desarrollar productos sobresalientes con las mejores herramientas tecnológicas de la industria, por esto las siguientes características nos convierten en la mejor opción para tu empresa.
                        </h5>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4" data-aos="fade-down" data-aos-delay="67">
                    <img src="./assets/images/desarrollo-software.png" alt="Desarrollo de Software" class="desarrollo img-fluid rounded mx-auto d-block" alt="Desarrollo Web">
                    <div class="lenguages">
                        <img src="./assets/images/Clases/lang.png" class="img-fluid" alt="Lenguaje de Programación">
                    </div>
                    <div class="lenguages">
                        <img src="./assets/images/Clases/lang2.png" class="img-fluid" alt="Lenguaje de Programación">
                    </div>
                    <div class="lenguages">
                        <img src="./assets/images/movisoft2.jpg" alt="Lenguaje de Programación">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 text-center line-top">
                <div class="line text-center" data-aos="fade-down" data-aos-delay="69"></div>
                    <h1 class="title display-4 fw-semibold" data-aos="fade-down" data-aos-delay="70">GARANTIZAMOS CALIDAD Y RESPALDO</h1>
                    <p class="letra" data-aos="fade-down" data-aos-delay="72">Nuestra metodología de trabajo está dirigida a entregar un proyecto que cumpla con lo esperado , por eso desarrollamos cada proyecto con entusiasmo y compromiso, garantizándote así una página web de calidad con el respaldo de un equipo de trabajo profesional y multidisciplinario.</p>
                    <p class="letra" data-aos="fade-down" data-aos-delay="75">También queremos que sepas que vemos cada cliente como una oportunidad de conocimiento más que una oportunidad de negocio, nuestra intención es crear una relación a largo plazo donde podamos asesorarte y ayudarte en el crecimiento de tu empresa en <a href="index.php">MovisoftVC</a> creemos que las buenas relaciones duran más que los buenos negocios.</p>
                    <p class="letra" data-aos="fade-down" data-aos-delay="77"><a href="index.php"><strong>MovisoftVC</strong> </a> puede proporcionar todos estos <a data-bs-toggle="tooltip" data-bs-placement="right" title="Servicios Informáticos-Movisoft"  href="index.php">servicios a empresas</a> y organizaciones, desde la planificación y diseño de su sitio web, hasta la creación y mantenimiento del mismo, realizando una programación de simples páginas html, utilizando herramientas específicas (como gestores de contenido, servidores, blog…), o integrando en sus páginas directamente la programación de las funciones que su sitio web requiera.</p>
                </div>
            </div>
        </div>
    </section>
