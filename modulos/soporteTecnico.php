...
<section id="soporte" class="min-vh-100 d-flex align-items-center text-center">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 data-aos="fade-left" class="bienvenida text-uppercase text-white fw-semibold display-1">Mantenimiento y reparación de computadoras y laptops</h1>
                <h5 class="bienvenida text-white mt-3 mb-4" data-aos="fade-right">Servicio implementado por Movisoft S.U.R.L, diagnostico, mantenimiento y reparación de computadoras, cuenta con Técnicos Profesionales, ampliamente capacitados para atender desde un equipo o llevar la gestión de un departamento TI.</h5>
                    <div data-aos="fade-down" data-aos-delay="50">
                        <a href="" class="btn btn-brand me-2">Ver</a>
                    </div>
            </div>
        </div>
    </div>
</section>
<section id="descSoporte" class="section-g-padding">
    <div class="container">
        <div class="row" data-aos="fade-down">
            <div class="col-lg-12 text-center">
                <div class="section-title">
                    <h1 data-aos="fade-down" data-aos-delay="50" class="text-upercace title display-4 fw-semibold">Soporte Técnico Especializado</h1>
                    <h5><a href="index.php">MovisoftVC</a> le proporciona toda una gama de servicios de soporte técnico de alta calidad que le permiten organizar su garantía de calidad y controlar las actividades de forma eficiente y efectiva.</h5>
                </div>
            </div>
        </div>
        <div class="row" data-aos="fade-down">
